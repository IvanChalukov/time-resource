...
func (tc testCase) Run() {
	...
	if tc.start_after != "" {
		...
		Expect(err).NotTo(HaveOccurred())
		startTimeModel := models.NewStartAfter(startTime.UTC())
...
var _ = DescribeTable("Start time with a range and interval", (testCase).Run,
	...
	Entry("start_after is exactly at the start of the range", testCase{
		interval:    "2m",
		start:       "1:00 PM +0000",
		stop:        "3:00 PM +0000",
		start_after: "2017-12-31T00:00:00",
	...
	Entry("start_after is exactly at the stop of the range", testCase{
		interval:    "2m",
		start:       "1:00 PM +0000",
		stop:        "3:00 PM +0000",
		start_after: "2017-12-31T00:00:00",
